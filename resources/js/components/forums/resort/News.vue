...
<template>
    <div class="h-full p-4 rounded-lg shadow-md">
        <Link :href="`/forums/categories/travel/${continentSlug}/${countrySlug}/${resortSlug}/news/posts`">
            <h2 class="mb-4 text-2xl font-bold text-center text-cyan-200 hover:text-white">News</h2>

            <div v-if="newsPosts.length === 0" class="text-center text-gray-400">
                No news posts found.
            </div>
