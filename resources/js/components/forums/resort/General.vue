...
<template>
    <div class="h-full p-4 rounded-lg shadow-md">
        <Link :href="`/forums/categories/travel/${continentSlug}/${countrySlug}/${resortSlug}/general/posts`">
            <h2 class="mb-4 text-2xl font-bold text-center text-sky-200 hover:text-white">General</h2>

            <div v-if="generalPosts.length === 0" class="text-center text-gray-400">
